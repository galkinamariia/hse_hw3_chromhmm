...
| 8 |Heterochromatin|Данное состояние попадает на интрон и экзон гена. Показывает низкий сигнал. Чаще всего ассоциировано с ядерной ламиной, т.е. попадает на участок репрессированного гетерохроматина. Почти не встречается|Чаще всего ассоциировано с: <ul><li>Genome<li>laminB1lands|![](./img/8.png)|
...
| 10 |Heterochromatin|Данное состояние попадает на интрон гена и показывает низкий сигнал. Чаще всего ассоциировано с ядерной ламиной, т.е. попадает на участок репрессированного гетерохроматина. Почти не встречается, кроме: <ul><li>H3k27me3|Чаще всего ассоциировано с: <ul><li>laminB1lands<li>Genome|![](./img/10.png)|
